            ...
            <div class="row justify-content-center authentication authentication-basic align-items-center h-100">
                <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-6 col-sm-8 col-12">
                    <div class="my-4 d-flex justify-content-center">
                        <a href="index.html">
                            <img src="{{ asset('img/banner-upea.png') }}" width="300" alt="logo">
                        </a>
                    </div>
                        ...
                        <div class="card-body p-5">
                            ...
                            <div class="row gy-3">
                                <div class="col-xl-12">
                                    ...
                                    <input type="text" class="form-control form-control-lg" id="signin-username" placeholder="Usuario">
                                <div class="col-xl-12 mb-2">
                                    <label for="signin-password" class="form-label text-default d-block">Contraseña
                                        {{-- <a href="reset-password.html" class="float-end text-danger">¿Olvidaste la contraseña?</a> --}}
                                    </label>
                                    <div class="input-group">
                                        <input type="password" class="form-control form-control-lg" id="signin-password" placeholder="Contraseña">
                                ...
                                <div class="col-xl-12 d-grid mt-2">
                                    <a href="index.html" class="btn btn-lg btn-primary">Iniciar sesión</a>
                                </div>
                            </div>
                            {{-- <div class="text-center">
                                <p class="text-muted mt-3">¿No tienes una cuenta? <a href="sign-up.html" class="text-primary">Registrate</a></p>
                            </div> --}}
